...
% However, these limitations are also a blessing, for example it can be proven there exists continuous functions
% which are every continuous but nowhere differentiable (even weirder, they can be strictly increasing
% \emph{and} almost everywhere differentiable and have derivative 0)!
